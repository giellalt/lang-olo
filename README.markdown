...
This directory contains source files for the Olonets Karelian language
...
In order to compile and use Livvi language morphology and dictionaries,
you need:
...
The Livvi language sources can be acquired using [giella SVN
